...
function fallbackPack(locale: string, soulMap: string, convergence: string, startFree: string): LocalePack {
  const profiles: Record<string, Partial<LocalePack>> = {
    hr: { learnMore: "Saznajte više", readMore: "Pročitajte više", faq: "Česta pitanja", overview: "Pregled", method: "Metoda", limits: "Granice", privacy: "Podaci i sigurnost", premium: "Premium dubina", daily: "Dnevni impuls", relationship: "Odnos", book: "Knjiga profila", title: "Hermetia povezuje sustave, podatke i osobnu refleksiju", lead: "Ova stranica donosi lokalnu uredničku verziju s jasnom metodom i vidljivim granicama.", body: "Hermetia pretvara izračunate signale i dobrovoljne odgovore u miran prostor za samorefleksiju.", question: "Što ova tema znači u Hermetiji?", answer: "Pomaže razumjeti profil, podatke, konvergenciju i odgovorne granice prije plaćene dubine.", section: "Urednička orijentacija", safeNote: "Inspiracija za samorefleksiju, bez dijagnoze, terapije ili sigurnog predviđanja." },
    cs: { learnMore: "Zjistit více", readMore: "Číst dál", faq: "Časté otázky", overview: "Přehled", method: "Metoda", limits: "Hranice", privacy: "Data a bezpečnost", premium: "Prémiová hloubka", daily: "Denní impulz", relationship: "Vztah", book: "Kniha profilu", title: "Hermetia propojuje systémy, data a osobní reflexi", lead: "Tato stránka nabízí místní redakční verzi s jasnou metodou a viditelnými hranicemi.", body: "Hermetia převádí vypočtené signály a dobrovolné odpovědi do klidné sebereflexe.", question: "Co toto téma znamená v Hermetii?", answer: "Pomáhá pochopit profil, data, konvergenci a odpovědné hranice před placenou hloubkou.", section: "Redakční orientace", safeNote: "Inspirace k sebereflexi, bez diagnózy, terapie nebo jisté předpovědi." },
    da: { learnMore: "Læs mere", readMore: "Læs videre", faq: "Ofte stillede spørgsmål", overview: "Overblik", method: "Metode", limits: "Grænser", privacy: "Data og sikkerhed", premium: "Premium-dybde", daily: "Daglig impuls", relationship: "Relation", book: "Profilbog", title: "Hermetia forbinder systemer, data og personlig refleksion", lead: "Denne side giver en lokal redaktionel version med klar metode og synlige grænser.", body: "Hermetia omsætter beregnede signaler og frivillige svar til rolig selvrefleksion.", question: "Hvad betyder dette i Hermetia?", answer: "Det hjælper med at forstå profil, data, konvergens og ansvarlige grænser før betalt dybde.", section: "Redaktionel orientering", safeNote: "Inspiration til selvrefleksion, uden diagnose, terapi eller sikker forudsigelse." },
    et: { learnMore: "Loe rohkem", readMore: "Jätka lugemist", faq: "Korduma kippuvad küsimused", overview: "Ülevaade", method: "Meetod", limits: "Piirid", privacy: "Andmed ja turvalisus", premium: "Premium-sügavus", daily: "Päevaimpulss", relationship: "Suhe", book: "Profiiliraamat", title: "Hermetia ühendab süsteemid, andmed ja isikliku eneserefleksiooni", lead: "See leht pakub kohalikku toimetatud versiooni selge meetodi ja nähtavate piiridega.", body: "Hermetia muudab arvutatud signaalid ja vabatahtlikud vastused rahulikuks enesevaatluseks.", question: "Mida see teema Hermetias tähendab?", answer: "See aitab mõista profiili, andmeid, konvergentsi ja vastutustundlikke piire enne tasulist sügavust.", section: "Toimetuslik orientatsioon", safeNote: "Inspiratsioon eneserefleksiooniks, mitte diagnoos, teraapia ega kindel ennustus." },
    fi: { learnMore: "Lue lisää", readMore: "Jatka lukemista", faq: "Usein kysytyt kysymykset", overview: "Yleiskuva", method: "Menetelmä", limits: "Rajat", privacy: "Tiedot ja turvallisuus", premium: "Premium-syvyys", daily: "Päivän impulssi", relationship: "Suhde", book: "Profiilikirja", title: "Hermetia yhdistää järjestelmät, tiedot ja henkilökohtaisen pohdinnan", lead: "Tämä sivu tarjoaa paikallisen toimituksellisen version, jossa menetelmä ja rajat ovat selkeitä.", body: "Hermetia muuntaa lasketut signaalit ja vapaaehtoiset vastaukset rauhalliseksi itsetutkiskeluksi.", question: "Mitä tämä aihe tarkoittaa Hermetiassa?", answer: "Se auttaa ymmärtämään profiilia, tietoja, konvergenssia ja vastuullisia rajoja ennen maksullista syvyyttä.", section: "Toimituksellinen orientaatio", safeNote: "Inspiraatiota itsetutkiskeluun, ei diagnoosia, terapiaa tai varmaa ennustetta." },
    el: { learnMore: "Μάθετε περισσότερα", readMore: "Διαβάστε περισσότερα", faq: "Συχνές ερωτήσεις", overview: "Επισκόπηση", method: "Μέθοδος", limits: "Όρια", privacy: "Δεδομένα και ασφάλεια", premium: "Premium βάθος", daily: "Ημερήσια ώθηση", relationship: "Σχέση", book: "Βιβλίο προφίλ", title: "Η Hermetia συνδέει συστήματα, δεδομένα και προσωπικό στοχασμό", lead: "Αυτή η σελίδα προσφέρει τοπική επιμελημένη έκδοση με σαφή μέθοδο και ορατά όρια.", body: "Η Hermetia μετατρέπει υπολογισμένα σήματα και εθελοντικές απαντήσεις σε ήρεμο αυτοστοχασμό.", question: "Τι σημαίνει αυτό το θέμα στη Hermetia;", answer: "Βοηθά να κατανοήσετε το προφίλ, τα δεδομένα, τη σύγκλιση και τα υπεύθυνα όρια πριν από πληρωμένη εμβάθυνση.", section: "Εκδοτικός προσανατολισμός", safeNote: "Έμπνευση για αυτοστοχασμό, χωρίς διάγνωση, θεραπεία ή βέβαιη πρόβλεψη." },
    hu: { learnMore: "Tudjon meg többet", readMore: "Olvasson tovább", faq: "Gyakori kérdések", overview: "Áttekintés", method: "Módszer", limits: "Határok", privacy: "Adatok és biztonság", premium: "Prémium mélység", daily: "Napi impulzus", relationship: "Kapcsolat", book: "Profilkönyv", title: "A Hermetia rendszereket, adatokat és személyes önreflexiót kapcsol össze", lead: "Ez az oldal helyi szerkesztett változatot ad világos módszerrel és látható határokkal.", body: "A Hermetia számított jeleket és önkéntes válaszokat alakít nyugodt önreflexióvá.", question: "Mit jelent ez a téma a Hermetiában?", answer: "Segít megérteni a profilt, az adatokat, a konvergenciát és a felelős határokat a fizetett mélység előtt.", section: "Szerkesztői tájékozódás", safeNote: "Inspiráció önreflexióhoz, diagnózis, terápia vagy biztos jóslat nélkül." },
    ga: { learnMore: "Tuilleadh eolais", readMore: "Léigh ar aghaidh", faq: "Ceisteanna coitianta", overview: "Forbhreathnú", method: "Modh", limits: "Teorainneacha", privacy: "Sonraí agus slándáil", premium: "Doimhneacht phréimhe", daily: "Spreagadh laethúil", relationship: "Caidreamh", book: "Leabhar próifíle", title: "Nascann Hermetia córais, sonraí agus machnamh pearsanta", lead: "Tugann an leathanach seo leagan eagarthóireachta áitiúil le modh soiléir agus teorainneacha infheicthe.", body: "Athraíonn Hermetia comharthaí ríofa agus freagraí deonacha ina mhachnamh ciúin.", question: "Cad a chiallaíonn an téama seo in Hermetia?", answer: "Cabhraíonn sé leis an bpróifíl, sonraí, cóineasú agus teorainneacha freagracha a thuiscint roimh dhoimhneacht íoctha.", section: "Treoshuíomh eagarthóireachta", safeNote: "Spreagadh don fhéinmhachnamh, gan diagnóis, teiripe ná tuar cinnte." },
    lv: { learnMore: "Uzzināt vairāk", readMore: "Lasīt tālāk", faq: "Bieži jautājumi", overview: "Pārskats", method: "Metode", limits: "Robežas", privacy: "Dati un drošība", premium: "Premium dziļums", daily: "Dienas impulss", relationship: "Attiecības", book: "Profila grāmata", title: "Hermetia savieno sistēmas, datus un personisku refleksiju", lead: "Šī lapa sniedz vietēju redakcionālu versiju ar skaidru metodi un redzamām robežām.", body: "Hermetia pārvērš aprēķinātus signālus un brīvprātīgas atbildes mierīgā pašrefleksijā.", question: "Ko šī tēma nozīmē Hermetia?", answer: "Tā palīdz saprast profilu, datus, konverģenci un atbildīgas robežas pirms maksas dziļuma.", section: "Redakcionāla orientācija", safeNote: "Iedvesma pašrefleksijai, ne diagnoze, terapija vai droša prognoze." },
    lt: { learnMore: "Sužinoti daugiau", readMore: "Skaityti toliau", faq: "Dažniausi klausimai", overview: "Apžvalga", method: "Metodas", limits: "Ribos", privacy: "Duomenys ir saugumas", premium: "Premium gylis", daily: "Dienos impulsas", relationship: "Santykis", book: "Profilio knyga", title: "Hermetia jungia sistemas, duomenis ir asmeninę refleksiją", lead: "Šis puslapis pateikia vietinę redakcinę versiją su aiškiu metodu ir matomomis ribomis.", body: "Hermetia paverčia apskaičiuotus signalus ir savanoriškus atsakymus ramia savirefleksija.", question: "Ką ši tema reiškia Hermetia?", answer: "Ji padeda suprasti profilį, duomenis, konvergenciją ir atsakingas ribas prieš mokamą gylį.", section: "Redakcinė orientacija", safeNote: "Įkvėpimas savirefleksijai, be diagnozės, terapijos ar tikros prognozės." },
    mt: { learnMore: "Sir af aktar", readMore: "Kompli aqra", faq: "Mistoqsijiet frekwenti", overview: "Ħarsa ġenerali", method: "Metodu", limits: "Limiti", privacy: "Data u sigurtà", premium: "Fond premium", daily: "Impuls ta' kuljum", relationship: "Relazzjoni", book: "Ktieb tal-profil", title: "Hermetia tgħaqqad sistemi, data u riflessjoni personali", lead: "Din il-paġna tagħti verżjoni editorjali lokali b'metodu ċar u limiti viżibbli.", body: "Hermetia tbiddel sinjali kkalkulati u tweġibiet volontarji f'riflessjoni kalma.", question: "Xi jfisser dan is-suġġett f'Hermetia?", answer: "Jgħin tifhem il-profil, id-data, il-konverġenza u l-limiti responsabbli qabel fond imħallas.", section: "Orjentazzjoni editorjali", safeNote: "Ispirazzjoni għal riflessjoni personali, mhux dijanjosi, terapija jew tbassir ċert." },
    ro: { learnMore: "Aflați mai mult", readMore: "Citiți mai departe", faq: "Întrebări frecvente", overview: "Prezentare generală", method: "Metodă", limits: "Limite", privacy: "Date și securitate", premium: "Profunzime premium", daily: "Impuls zilnic", relationship: "Relație", book: "Carte de profil", title: "Hermetia conectează sisteme, date și reflecție personală", lead: "Această pagină oferă o versiune editorială locală, cu metodă clară și limite vizibile.", body: "Hermetia transformă semnale calculate și răspunsuri voluntare într-o reflecție calmă.", question: "Ce înseamnă această temă în Hermetia?", answer: "Ajută la înțelegerea profilului, datelor, convergenței și limitelor responsabile înainte de profunzimea plătită.", section: "Orientare editorială", safeNote: "Inspirație pentru autoreflecție, fără diagnostic, terapie sau predicție sigură." },
    sk: { learnMore: "Zistiť viac", readMore: "Čítať ďalej", faq: "Časté otázky", overview: "Prehľad", method: "Metóda", limits: "Hranice", privacy: "Dáta a bezpečnosť", premium: "Prémiová hĺbka", daily: "Denný impulz", relationship: "Vzťah", book: "Kniha profilu", title: "Hermetia prepája systémy, dáta a osobnú reflexiu", lead: "Táto stránka prináša lokálnu redakčnú verziu s jasnou metódou a viditeľnými hranicami.", body: "Hermetia premieňa vypočítané signály a dobrovoľné odpovede na pokojnú sebareflexiu.", question: "Čo táto téma znamená v Hermetii?", answer: "Pomáha pochopiť profil, dáta, konvergenciu a zodpovedné hranice pred platenou hĺbkou.", section: "Redakčná orientácia", safeNote: "Inšpirácia na sebareflexiu, bez diagnózy, terapie alebo istej predpovede." },
    sl: { learnMore: "Izvedite več", readMore: "Preberite naprej", faq: "Pogosta vprašanja", overview: "Pregled", method: "Metoda", limits: "Meje", privacy: "Podatki in varnost", premium: "Premium globina", daily: "Dnevni impulz", relationship: "Odnos", book: "Knjiga profila", title: "Hermetia povezuje sisteme, podatke in osebno refleksijo", lead: "Ta stran prinaša lokalno uredniško različico z jasno metodo in vidnimi mejami.", body: "Hermetia pretvori izračunane signale in prostovoljne odgovore v mirno samorefleksijo.", question: "Kaj ta tema pomeni v Hermetii?", answer: "Pomaga razumeti profil, podatke, konvergenco in odgovorne meje pred plačano globino.", section: "Uredniška orientacija", safeNote: "Navdih za samorefleksijo, brez diagnoze, terapije ali zanesljive napovedi." },
    sv: { learnMore: "Läs mer", readMore: "Läs vidare", faq: "Vanliga frågor", overview: "Översikt", method: "Metod", limits: "Gränser", privacy: "Data och säkerhet", premium: "Premiumdjup", daily: "Daglig impuls", relationship: "Relation", book: "Profilbok", title: "Hermetia förenar system, data och personlig reflektion", lead: "Den här sidan ger en lokal redaktionell version med tydlig metod och synliga gränser.", body: "Hermetia omvandlar beräknade signaler och frivilliga svar till lugn självreflektion.", question: "Vad betyder detta ämne i Hermetia?", answer: "Det hjälper till att förstå profil, data, konvergens och ansvarsfulla gränser före betalt djup.", section: "Redaktionell orientering", safeNote: "Inspiration för självreflektion, utan diagnos, terapi eller säker prognos." },
  };
  ...
  return {
    ...
    question: p.question ?? "What does this mean in Hermetia?",
    ...
    ctaText: p.ctaText ?? `${p.title ?? "Hermetia"}: ${convergence}, ${soulMap}, ${p.method ?? "method"}.`,
    seoDescription: p.seoDescription ?? `${soulMap}, ${convergence}, sensitive data and AI limits explained clearly in Hermetia.`,
    ...
    glossaryIntro: p.glossaryIntro ?? p.answer ?? "This term helps explain Hermetia's method, data and language.",
...
export function localizedRouteLabel(locale: Locale, routePath: string, detailLabel?: string) {
  const p = pack(locale);
  if (!p) return detailLabel ?? "Hermetia";
