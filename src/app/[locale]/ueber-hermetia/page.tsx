...
const faq = [
  {
    ...
    a: "Hermetia ist eine AI-gestützte Reflexionsplattform, die berechnete Systemsignale zu einer verständlichen Seelenkarte verdichtet und Menschen behutsam in Selbstreflexion, Journaling und Alltag begleitet.",
  },
  {
    q: "Warum verbindet Hermetia so viele Systeme?",
    a: "Ein einzelnes System bleibt immer eine Perspektive. Hermetia sucht deshalb nach Konvergenz: Themen werden relevanter, wenn mehrere unabhängige Systemfamilien auf dieselbe Qualität zeigen.",
  },
  {
    q: "Ist Hermetia wissenschaftliche Diagnostik?",
    a: "Nein. Hermetia ist keine medizinische, psychologische, therapeutische, rechtliche oder finanzielle Beratung. Die Inhalte sind als Reflexionsimpulse und nicht als Diagnose oder Vorhersage zu verstehen.",
  },
  {
    q: "Wie geht Hermetia mit sensiblen Daten um?",
...
const principles = [
  {
    ...
    text: "Hermetia trennt Rechenkern, Konvergenzlogik und sprachliche Deutung. Systemdaten werden reproduzierbar berechnet, bevor AI oder redaktionelle Sprache sie lesbar machen.",
  },
  {
  ...
  },
  {
    ...
    text: "Hermetia darf berühren, aber nicht übergriffig werden. Medizinische, therapeutische, rechtliche und finanzielle Aussagen bleiben ausgeschlossen.",
  },
  {
...
const trustBlocks = [
  {
    ...
    text: "Hermetia verwendet eigene Formulierungen und eigene Struktur. Proprietäre Kartentexte, Fragebogenitems, Markenlogiken oder geschützte Originaldeutungen werden nicht übernommen.",
  },
  {
    label: "Daten",
  ...
  },
  {
    ...
    text: "AI kann Muster verständlicher formulieren. Sie entscheidet aber nicht darüber, wer ein Mensch ist. Hermetia rahmt AI als unterstützende Text- und Reflexionsschicht.",
  },
];
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    path: paths.about,
    title: "Über Hermetia — Haltung, Methode und Vertrauen",
    description:
      "Warum Hermetia Seelenkarte, Konvergenz-Engine, AI-Transparenz, Datenschutz und bezahlte Begleitung verbindet und welche Grenzen bewusst eingebaut sind.",
  });
}
      ...
      <JsonLd
        data={[
          ...
          breadcrumbSchema([
            ...
            { name: "Über Hermetia", url: pageUrl },
          ]),
        ]}
      />
      ...
      <main>
        <section className="pb-10 pt-16">
          <div className="wrap grid items-center gap-10 lg:grid-cols-[1.05fr_.95fr]">
            <div>
              <span className="kicker">Über Hermetia</span>
              ...
              <p className="lead mt-5 max-w-[720px]">
                Hermetia übersetzt spirituelle und psychologische Systeme in eine persönliche Seelenkarte. Das Ziel ist nicht, Menschen zu vermessen. Das Ziel ist, Muster sichtbar zu machen, Sprache für innere Erfahrung zu geben und eine ruhige Begleitung in den Alltag zu bringen.
              </p>
            ...
            <figure className="m-0 overflow-hidden rounded-card border border-sand bg-white shadow-soft">
              <img src="/images/hermetia/alchemical-listening-room.png" alt="Ein ruhiger Hermetia-Raum als Bild für Reflexion und innere Übersetzung" className="aspect-[4/3] w-full object-cover" />
              <figcaption className="px-5 py-4 text-[14px] text-pflaume/80">
                Hermetia ist als ruhiger Raum gedacht: berechnet im Fundament, warm in der Sprache, transparent in den Grenzen.
              </figcaption>
            </figure>
          </div>
        </section>
        ...
        <section className="bg-creme-tief py-16">
          <div className="wrap">
            <div className="max-w-[760px]">
              <span className="kicker">Warum es Hermetia gibt</span>
        ...
        <section className="py-16">
          <div className="wrap grid gap-8 lg:grid-cols-[.85fr_1.15fr]">
            <div>
              <span className="kicker">Was Hermetia anders macht</span>
              <h2 className="mt-3 text-[clamp(27px,4vw,38px)]">Nicht mehr Systeme. Mehr Zusammenhang.</h2>
              <p className="muted mt-4 text-[17px] leading-[1.85]">
                Hermetia sammelt Systeme nicht als Schaulaufen. Entscheidend ist, ob unabhängige Perspektiven ein Thema wirklich tragen. Die Konvergenz-Engine bündelt verwandte Quellen, dämpft Doppelzählungen und macht sichtbar, wo mehrere Wege auf denselben Punkt zeigen.
              </p>
          ...
          <div className="wrap">
            <div className="max-w-[760px]">
              ...
              <p className="mt-4 text-[17px] leading-[1.85] text-[#e9dcf2]">
                Hermetia berührt Identität, Beziehung, Sinn und Weltanschauung. Genau deshalb gehören rechtliche, ethische und technische Grenzen nicht ans Ende, sondern in das Produkt selbst.
              </p>
            </div>
        ...
        <section className="bg-creme-tief py-16">
          <div className="wrap">
            <div className="mb-8 text-center">
              ...
              <h2 className="mt-3 text-[clamp(27px,4vw,36px)]">Fragen zu Hermetias Haltung</h2>
            </div>
            <Faq items={faq} />
          </div>
        </section>
