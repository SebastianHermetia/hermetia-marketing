...
const books: BookRecommendation[] = [
  ...
  },
  {
    ...
    description: {
      de: "Ein praxisnahes Arbeitsbuch, das Leser Schritt für Schritt durch die Deutung des eigenen Horoskops führt. Gut als Vertiefung nach einer ersten Astrakey-Lesung.",
      en: "A practical workbook that guides readers step by step through interpreting their own chart. A good follow-up after a first Astrakey reading.",
    },
    systems: ["astrologie"],
  ...
  // ── Human Design ──────────────────────────────────────────────────────────
  {
    ...
    level: { de: "Einstieg", en: "Introduction" },
    description: {
      de: "Eine nutzerfreundliche Einführung in Typ, Strategie, Autorität und Energiezentren. Gut geeignet, um Astrakeys Human-Design-Ergebnisse besser einzuordnen.",
      en: "A user-friendly introduction to type, strategy, authority and energy centres. Useful for understanding Astrakey's Human Design layer.",
    },
  ...
  // ── Gene Keys ─────────────────────────────────────────────────────────────
  {
    ...
    description: {
      de: "Das zentrale Werk zum Gene-Keys-System mit 64 Archetypen und dem Weg von Schatten über Gabe zu Siddhi. Als externe Vertiefung geeignet, nicht als Textquelle für Astrakey.",
      en: "The central work of the Gene Keys system, with 64 archetypes and the path from shadow through gift to siddhi. Useful as external reading, not as a source text for Astrakey.",
    },
    systems: ["gene-keys"],
  ...
  },
  {
    ...
    description: {
      de: "Ein populäres Werk zu Maya-Zeitzyklen. Für Astrakey nur als moderner Deutungskontext, nicht als historische Primärquelle, sinnvoll.",
      en: "A popular work on Maya time cycles. For Astrakey it is useful only as modern interpretive context, not as a historical primary source.",
    },
    systems: ["maya-tzolkin"],
  ...
  // ── Ayurveda ──────────────────────────────────────────────────────────────
  {
    ...
    level: { de: "Einstieg", en: "Introduction" },
    description: {
      de: "Ein klassischer Einstieg in Doshas und ayurvedische Grundbegriffe. Bei Astrakey nur als Selbstreflexion, nicht als medizinischer Rat.",
      en: "A classic introduction to doshas and Ayurvedic foundations. In Astrakey this is framed as self-reflection, not medical advice.",
    },
  ...
  },
  {
    ...
    description: {
      de: "Eine Vertiefung zur ayurvedischen Konstitution. Bei Astrakey nur als Reflexionsliteratur mit klarem Gesundheits-Disclaimer passend.",
      en: "A deepening of Ayurvedic constitution. In Astrakey it fits only as reflective reading with a clear health disclaimer.",
    },
    systems: ["ayurveda-dosha"],
  ...
  },
  {
    ...
    description: {
      de: "Zentrales populäres Werk zum Cards-of-Destiny-System. Wegen IP-Nähe nur als externe Empfehlung, nicht als Content-Basis für Astrakey.",
      en: "A central popular work on the Cards of Destiny system. Because of IP proximity it is only an external recommendation, not a content source for Astrakey.",
    },
    systems: ["cards-of-destiny"],
  ...
  // ── Sabian Symbols ────────────────────────────────────────────────────────
  {
    ...
    description: {
      de: "Ein bekanntes Werk zu den 360 Sabischen Symbolen. Als externe Lektüre empfohlen; keine Symboltexte in Astrakey übernommen.",
      en: "A well-known work on the 360 Sabian symbols. Recommended as external reading; no symbol texts are adopted into Astrakey.",
    },
  ...
  // ── RIASEC / Laufbahninteressen ───────────────────────────────────────────
  {
    ...
    description: {
      de: "Grundlagenwerk hinter dem RIASEC-Modell beruflicher Interessen. Für Astrakey als Berufungs- und Interessenkontext geeignet, nicht als starre Einstufung.",
  ...
  // ── Chronotyp ─────────────────────────────────────────────────────────────
  {
    ...
    description: {
      de: "Populärwissenschaftliche Einführung in Chronotypen und Tagesrhythmus. Bei Astrakey passend als Reflexionshilfe, nicht als Schlafdiagnostik.",
      en: "A popular-science introduction to chronotypes and daily rhythm. In Astrakey it fits as reflection support, not sleep diagnostics.",
    },
    systems: ["chronotyp"],
  ...
  // ── 16 Types ──────────────────────────────────────────────────────────────
  {
    ...
    level: { de: "Kontext", en: "Context" },
    description: {
      de: "Historischer Klassiker zur Myers-Briggs-Typologie. Für Astrakey als Kontext zu kognitiven Präferenzen geeignet — keine Markenbezeichnung wird direkt übernommen.",
      en: "A historical classic on Myers-Briggs typology. Useful in Astrakey as context for cognitive preferences — no trademark designations are adopted directly.",
    },
  ...
  },
  {
    ...
    description: {
      de: "Populäre Typologie nach Temperamenten. Für Astrakey nur als allgemeiner Kontext, nicht als exakte methodische Grundlage.",
      en: "A popular temperament-based typology. For Astrakey it is general context only, not an exact methodological basis.",
    },
    systems: ["sixteen-types"],
  ...
  // ── TCM ────────────────────────────────────────────────────────────────────
  {
    ...
    description: {
      de: "Ein Klassiker zum Denkmodell der chinesischen Medizin. Für Astrakey nur mit klarem Hinweis: Reflexionsmodell, keine Diagnose.",
      en: "A classic on the thinking model of Chinese medicine. In Astrakey this requires a clear frame: reflection model, not diagnosis.",
    },
  ...
  },
  {
    ...
    description: {
      de: "Lesbare Einführung in chinesische Medizin und Fünf-Elemente-Denken. Für Astrakey nur nicht-diagnostisch und als Selbstbeobachtung passend.",
      en: "A readable introduction to Chinese medicine and Five Element thinking. In Astrakey it fits only non-diagnostically as self-observation.",
    },
    systems: ["tcm-konstitution"],
  ...
  // ── VIA-Stärken ────────────────────────────────────────────────────────────
  {
    ...
    level: { de: "Praxis", en: "Practice" },
    description: {
      de: "Ein praxisnahes Buch zur Anwendung von Charakterstärken im Alltag. Passend zur ressourcenorientierten Seite von Astrakey.",
      en: "A practical book on applying character strengths in everyday life. A good fit for Astrakey's resource-oriented layer.",
    },
  ...
  },
  {
    ...
    level: { de: "Grundlagenwerk", en: "Foundational" },
    description: {
      de: "Wissenschaftliches Grundlagenwerk zur VIA-Klassifikation. Gut als redaktioneller Anker für die ressourcenorientierte Seite von Astrakey.",
      en: "The research foundation of the VIA classification. A good editorial anchor for Astrakey's resource-oriented layer.",
    },
    systems: ["via-staerken"],
  ...
  // ── Spiral Dynamics ────────────────────────────────────────────────────────
  {
    ...
    level: { de: "Quellenkontext", en: "Source context" },
    description: {
      de: "Der Ursprungstext zum modernen Spiral-Dynamics-Modell. In Astrakey nur als externer Kontext, nicht als starre Einstufung von Menschen.",
      en: "The source text for the modern Spiral Dynamics model. In Astrakey it is external context, not a rigid ranking of people.",
    },
  ...
  // ── Mahabote / burmesischer Kalenderkontext ───────────────────────────────
  {
    ...
    description: {
      de: "Kulturhistorischer Kontext zu burmesischen Volks- und Kalendersymbolen. Für Astrakey besser als vorsichtiger Hintergrund geeignet als ein modernes Deutungsmanual.",
      en: "Cultural-historical context for Burmese folk and calendar symbols. Better suited to Astrakey as careful background than as a modern reading manual.",
    },
    systems: ["mahabote"],
