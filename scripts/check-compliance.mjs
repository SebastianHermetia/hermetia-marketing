...
const checks = [
  ...
  ["Live export exposes consent and legal gates", legalPage.includes("Klare Gates für Daten, AI, IP und Recht.")],
  ["Live export exposes language quality page", languagePage.includes("Dein Profil in deiner Sprache") && languagePage.includes("24 EU-Sprachen")],
