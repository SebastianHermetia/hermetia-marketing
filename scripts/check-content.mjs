...
const checks = [
  ...
  ["Language status page reports UI-localized locales", languages.includes("UI lokalisiert") && languages.includes(">6<")],
  ["Language status page reports fallback locales", languages.includes("Technischer Fallback") && languages.includes(">16<")],
