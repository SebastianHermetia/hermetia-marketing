...
const checks = [
  ...
  ["System detail has literature recommendations", systemDetail.includes("Bücher zu Human Design") && systemDetail.includes("Understanding Human Design") && systemDetail.includes("freigegebene Affiliate-Links")],
  ["System detail book links are nofollow", systemDetail.includes("rel=\"nofollow noopener noreferrer\"") && systemDetail.includes("Hermetia zeigt Preise und Verfügbarkeit erst")],
  ...
  ["Systems hub literature has compliance note", systemsHub.includes("Affiliate-Links können später") && systemsHub.includes("Preise und Verfügbarkeit werden bewusst nicht angezeigt")],
