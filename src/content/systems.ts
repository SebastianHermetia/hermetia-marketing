...
// „Was ist <System>“ + wie Astrakey es nutzt. DE+EN, FAQ für AEO/Schema.org.
...
const W = "Was ist";
const HOW_DE = "Wie Astrakey es berechnet";
const REV_DE = "Was es über dich zeigt";
const HOW_EN = "How Astrakey calculates it";
...
function simpleSystem(input: {
  ...
  const de: SystemText = {
    ...
    seoTitle: `${input.name} erklärt — Bedeutung und Berechnung bei Astrakey`,
    seoDescription: `${input.name} verständlich erklärt: was das System zeigt, wie Astrakey es berechnet und wie es in die Seelenkarte einfließt.`,
    intro: `${input.name} ergänzt Astrakeys Seelenkarte um eine weitere Perspektive: ${input.tagline}.`,
    whatTitle: `${W} ${input.name}?`,
    what: `${input.name} gehört in Astrakey zur Familie ${input.family}. Es liefert keine absolute Wahrheit über dich, sondern ein eigenes Signal, das erst im Zusammenspiel mit anderen Systemen wirklich aussagekräftig wird.`,
    howTitle: HOW_DE,
    how: input.computed,
    revealsTitle: REV_DE,
    reveals: input.reveals,
    faq: [
      { q: `Warum nutzt Astrakey ${input.name}?`, a: `Weil ${input.name} einen Blickwinkel ergänzt, den andere Systeme nicht oder nur teilweise abdecken. In Astrakey wird dieser Blickwinkel mit anderen Signalen verglichen.` },
      { q: `Ist ${input.name} eine Diagnose oder Vorhersage?`, a: input.caution ?? "Nein. Astrakey nutzt das System als Reflexionssignal, nicht als Diagnose, Therapie, Beratung oder Schicksalsvorhersage." },
    ],
  };
  const en: SystemText = {
    name: input.name,
    tagline: input.tagline,
    seoTitle: `${input.name} explained — meaning and calculation at Astrakey`,
    seoDescription: `${input.name} explained clearly: what the system shows, how Astrakey calculates it and how it feeds the soul map.`,
    intro: `${input.name} adds another perspective to Astrakey's soul map: ${input.taglineEn ?? input.tagline}.`,
    whatTitle: `What is ${input.name}?`,
    what: `${input.name} belongs to the ${input.familyEn ?? input.family} family in Astrakey. It is not treated as an absolute truth, but as one signal that becomes meaningful in relation to other systems.`,
    howTitle: HOW_EN,
    how: input.computedEn ?? input.computed,
    revealsTitle: REV_EN,
    reveals: input.revealsEn ?? input.reveals,
    faq: [
      { q: `Why does Astrakey use ${input.name}?`, a: `Because ${input.name} adds a perspective that other systems do not fully cover. Astrakey compares this signal with other perspectives.` },
      { q: `Is ${input.name} a diagnosis or prediction?`, a: input.cautionEn ?? input.caution ?? "No. Astrakey uses the system as a reflection signal, not as diagnosis, therapy, advice or fate prediction." },
    ],
  };
...
export const systems: SystemEntry[] = [
  {
    ...
    de: {
      ...
      seoTitle: "Astrologie verstehen — wie Astrakey dein Geburtshoroskop liest",
      seoDescription: "Was Astrologie ist, wie Astrakey dein Geburtshoroskop exakt berechnet (Skyfield) und was Sonne, Mond und Aszendent über dich erzählen.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey bestimmt die exakten Himmelspositionen mit der quelloffenen Ephemeride Skyfield – auf Basis von Datum, Zeit und Ort. Ohne genaue Geburtszeit nutzen wir eine Tageszeit und kennzeichnen, was dennoch belastbar ist (z. B. Sonnen- und Mondzeichen-Tendenz).",
      revealsTitle: REV_DE,
      reveals: "Dein Sonnenzeichen (Wesenskern), Mondzeichen (Gefühlswelt) und – mit Uhrzeit – dein Aszendent (Auftreten) sowie die Häuser und Aspekte. In Astrakey speist das u. a. die Ebenen „Was dich ausmacht“, „Beziehungsmuster“ und „Rhythmus & Sensibilität“.",
      faq: [
        { q: "Brauche ich meine genaue Geburtszeit für Astrologie?", a: "Für Aszendent und Häuser ja; Sonnen- und Mondzeichen sind meist auch ohne exakte Uhrzeit zuverlässig. Astrakey kennzeichnet transparent, was gesichert ist." },
        { q: "Welche Astrologie verwendet Astrakey?", a: "Die westliche (tropische) Astrologie als Kernsystem, ergänzt um klassische Vertiefungen wie Hellenistik und Mondknoten." }
      ]
    },
    en: {
      name: "Astrology",
      tagline: "Sun, moon and planets at birth",
      seoTitle: "Understanding astrology — how Astrakey reads your birth chart",
      seoDescription: "What astrology is, how Astrakey calculates your birth chart precisely (Skyfield) and what sun, moon and ascendant reveal about you.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey computes the exact celestial positions with the open-source ephemeris Skyfield — based on date, time and place. Without an exact birth time we use a time of day and mark what remains reliable (e.g. sun and moon sign tendency).",
      revealsTitle: REV_EN,
      reveals: "Your sun sign (core self), moon sign (emotional world) and — with a time — your ascendant (outward style), houses and aspects. In Astrakey this feeds levels like “What makes you you”, “Relationship patterns” and “Rhythm & sensitivity”.",
      faq: [
        { q: "Do I need my exact birth time for astrology?", a: "For the ascendant and houses, yes; sun and moon signs are usually reliable even without an exact time. Astrakey transparently marks what is certain." },
        { q: "Which astrology does Astrakey use?", a: "Western (tropical) astrology as the core system, complemented by classic depth such as Hellenistic techniques and the lunar nodes." }
      ]
    }
  },
  {
    ...
    de: {
      ...
      seoTitle: "Human Design erklärt — Typ, Autorität & Bodygraph bei Astrakey",
      seoDescription: "Was Human Design ist, wie Astrakey deinen Bodygraph berechnet und was Typ, innere Autorität und Energiezentren über deine Entscheidungen verraten.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey berechnet zwei Momente: deine Geburt (Personality) und einen Punkt rund 88 Sonnengrade davor (Design). Daraus ergeben sich Typ, innere Autorität, offene/definierte Zentren und Aktivierungen – exakt aus den Ephemeriden, nicht geschätzt.",
      revealsTitle: REV_DE,
    ...
    en: {
      ...
      seoTitle: "Human Design explained — type, authority & bodygraph at Astrakey",
      seoDescription: "What Human Design is, how Astrakey calculates your bodygraph and what type, inner authority and energy centres reveal about your decisions.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey computes two moments: your birth (Personality) and a point about 88 solar degrees earlier (Design). From these come your type, inner authority, open/defined centres and activations — derived exactly from the ephemeris, not estimated.",
      revealsTitle: REV_EN,
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was die Gene Keys sind, wie Astrakey deine Schlüssel berechnet und wie der Weg von Schatten über Gabe zur höchsten Frequenz dein Wachstum begleitet.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey leitet deine zentralen Schlüssel aus denselben exakt berechneten Himmelspositionen ab wie Human Design (z. B. die hologenetischen Sphären). Die Deutung nutzt unseren eigenen, geprüften Korpus – keine geschützten Originaltexte.",
      revealsTitle: REV_DE,
    ...
    en: {
      ...
      seoDescription: "What the Gene Keys are, how Astrakey calculates your keys and how the path from shadow through gift to highest frequency supports your growth.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey derives your central keys from the same precisely calculated celestial positions as Human Design (e.g. the hologenetic spheres). The interpretation uses our own vetted corpus — no protected original texts.",
      revealsTitle: REV_EN,
      ...
      faq: [
        ...
        { q: "Does Astrakey use original Gene Keys texts?", a: "No. We use our own vetted corpus for the archetype triads; protected original texts are not fed into the AI model." }
      ]
    }
  },
  {
    ...
    de: {
      ...
      seoTitle: "Numerologie & Lebenszahl — Bedeutung berechnen bei Astrakey",
      seoDescription: "Was Numerologie ist, wie Astrakey deine Lebenszahl und Kernzahlen aus Name und Geburtsdatum berechnet und welche Zyklen sie sichtbar macht.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey berechnet deine Kernzahlen deterministisch aus Geburtsdatum und Geburtsnamen und leitet daraus persönliche Zyklen ab (z. B. dein persönliches Jahr).",
      revealsTitle: REV_DE,
      ...
      faq: [
        { q: "Welche Numerologie verwendet Astrakey?", a: "Die gängige pythagoräische Numerologie, ergänzt um persönliche Jahres- und Zyklusberechnungen." },
    ...
    en: {
      ...
      seoTitle: "Numerology & life path number — calculate the meaning at Astrakey",
      seoDescription: "What numerology is, how Astrakey calculates your life path and core numbers from name and birth date and which cycles it reveals.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey calculates your core numbers deterministically from birth date and birth name and derives personal cycles from them (e.g. your personal year).",
      revealsTitle: REV_EN,
      ...
      faq: [
        { q: "Which numerology does Astrakey use?", a: "Common Pythagorean numerology, complemented by personal year and cycle calculations." },
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was BaZi / die Vier Säulen des Schicksals sind, wie Astrakey dein Diagramm aus Jahr, Monat, Tag und Stunde berechnet und was es zeigt.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey konvertiert deine Geburtsdaten in den chinesischen Solar-/Mondkalender und bestimmt die vier Säulen sowie die Elemente-Verteilung – kalendergenau, basierend auf astronomischen Daten.",
      revealsTitle: REV_DE,
    ...
    en: {
      ...
      seoDescription: "What BaZi / the Four Pillars of Destiny are, how Astrakey calculates your chart from year, month, day and hour and what it reveals.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey converts your birth data into the Chinese solar/lunar calendar and determines the four pillars and the element distribution — calendar-accurate, based on astronomical data.",
      revealsTitle: REV_EN,
  ...
  },
  {
    ...
    de: {
      ...
      seoTitle: "Enneagramm-Typen — Test & Bedeutung bei Astrakey",
      seoDescription: "Was das Enneagramm ist, wie Astrakey deinen Typ über einen Fragebogen bestimmt und was die neun Muster über deine Tiefenmotivation verraten.",
      ...
      howTitle: HOW_DE,
      how: "Anders als die Geburtssysteme ermittelt Astrakey deinen Enneagramm-Typ über einen kurzen Fragebogen mit eigenen Items – kein Geburtsdatum nötig. Die Auswertung erfolgt als transparentes Scoring.",
      revealsTitle: REV_DE,
    ...
    en: {
      ...
      seoTitle: "Enneagram types — test & meaning at Astrakey",
      seoDescription: "What the Enneagram is, how Astrakey determines your type via a questionnaire and what the nine patterns reveal about your deep motivation.",
      ...
      howTitle: HOW_EN,
      how: "Unlike the birth systems, Astrakey determines your Enneagram type via a short questionnaire with our own items — no birth date needed. The evaluation is a transparent scoring.",
      revealsTitle: REV_EN,
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was der Maya-Tzolk’in-Kalender ist, wie Astrakey dein Kin (Ton + Zeichen) berechnet und welchen eigenen Archetyp-Raum er eröffnet.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey berechnet dein Kin rein arithmetisch aus dem Geburtsdatum (über die Julianische Tageszahl). Wir nutzen den traditionellen Tzolk’in – nicht das geschützte Dreamspell.",
      revealsTitle: REV_DE,
      ...
      faq: [
        { q: "Ist das Dreamspell dasselbe wie der Tzolk’in?", a: "Nein. Astrakey nutzt den traditionellen Tzolk’in; das modern abgewandelte Dreamspell ist urheberrechtlich geschützt und wird nicht verwendet." },
    ...
    en: {
      ...
      seoDescription: "What the Maya Tzolk’in calendar is, how Astrakey calculates your Kin (tone + sign) and what distinct archetype space it opens.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey calculates your Kin purely arithmetically from the birth date (via the Julian day number). We use the traditional Tzolk’in — not the protected Dreamspell.",
      revealsTitle: REV_EN,
      ...
      faq: [
        { q: "Is the Dreamspell the same as the Tzolk’in?", a: "No. Astrakey uses the traditional Tzolk’in; the modern Dreamspell variant is copyrighted and is not used." },
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was Nakshatras sind, wie Astrakey dein Geburts-Nakshatra über den siderischen Mond berechnet und welche feinen Nuancen es zeigt.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey bestimmt die exakte Mondposition (Skyfield) und rechnet sie mit der Lahiri-Ayanamsa in den siderischen Tierkreis um – daraus ergibt sich dein Nakshatra inklusive Pada.",
      revealsTitle: REV_DE,
    ...
    en: {
      ...
      seoDescription: "What Nakshatras are, how Astrakey calculates your birth Nakshatra via the sidereal moon and which subtle nuances it reveals.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey determines the exact moon position (Skyfield) and converts it into the sidereal zodiac with the Lahiri ayanamsa — yielding your Nakshatra including pada.",
      revealsTitle: REV_EN,
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was das I Ging ist, wie Astrakey ein Hexagramm als kontemplativen Tagesimpuls nutzt und warum es keine Vorhersage, sondern ein Spiegel ist.",
      ...
      howTitle: HOW_DE,
      how: "Für deinen Tagesimpuls zieht Astrakey ein Hexagramm und deutet es im Kontext deines Profils. Die Deutung stützt sich auf gemeinfreie Quellen (z. B. Legge) und unsere eigene Sprache.",
      revealsTitle: REV_DE,
      ...
      faq: [
        { q: "Sagt das I Ging die Zukunft voraus?", a: "Nein. Astrakey nutzt es als Spiegel und Reflexionsanstoß – einladend, nicht deterministisch." },
    ...
    en: {
      ...
      seoDescription: "What the I Ching is, how Astrakey uses a hexagram as a contemplative daily impulse and why it is a mirror, not a prediction.",
      ...
      howTitle: HOW_EN,
      how: "For your daily impulse Astrakey draws a hexagram and interprets it in the context of your profile. The interpretation draws on public-domain sources (e.g. Legge) and our own language.",
      revealsTitle: REV_EN,
      ...
      faq: [
        { q: "Does the I Ching predict the future?", a: "No. Astrakey uses it as a mirror and prompt for reflection — inviting, not deterministic." },
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was die Ayurveda-Doshas sind, wie Astrakey deinen Typ über einen Fragebogen bestimmt und wie er alltagsnahe Impulse speist.",
      intro: "Ayurveda beschreibt mit den drei Doshas (Vata, Pitta, Kapha) deine körperlich-energetische Konstitution – der einzige somatische Signaltyp in Astrakey.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey bestimmt deinen Dosha-Typ über einen einfühlsamen Fragebogen (kein Geburtsdatum). Wichtig: Ayurveda ist hier Inspiration zur Selbstfürsorge, keine medizinische Diagnose.",
      revealsTitle: REV_DE,
    ...
    en: {
      ...
      seoDescription: "What the Ayurveda doshas are, how Astrakey determines your type via a questionnaire and how it feeds everyday impulses.",
      intro: "With the three doshas (Vata, Pitta, Kapha) Ayurveda describes your bodily-energetic constitution — the only somatic signal type in Astrakey.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey determines your dosha type via a gentle questionnaire (no birth date). Important: here Ayurveda is inspiration for self-care, not a medical diagnosis.",
      revealsTitle: REV_EN,
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was hellenistische Astrologie ist, wie Astrakey Sekt und jährliche Profektionen berechnet und wie sie deinem Profil klassische Tiefe gibt.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey rechnet diese Techniken rein arithmetisch auf den bereits exakt bestimmten Skyfield-Positionen – ein vertiefender Layer über dem Standard-Horoskop.",
      revealsTitle: REV_DE,
    ...
    en: {
      ...
      seoDescription: "What Hellenistic astrology is, how Astrakey calculates sect and annual profections and how it adds classical depth to your profile.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey computes these techniques purely arithmetically on the already exact Skyfield positions — a deepening layer over the standard chart.",
      revealsTitle: REV_EN,
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was die Mondknoten sind, wie Astrakey die Knotenachse berechnet und was Nord- und Südknoten über deine Entwicklungsrichtung andeuten.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey berechnet die mittlere Knotenachse arithmetisch aus den Ephemeriden und ordnet sie deinen Zeichen/Häusern zu.",
      revealsTitle: REV_DE,
      reveals: "Deine Wachstumsrichtung (Nordknoten) und deine Komfortzone (Südknoten). Speist „Seelenweg“ und „Schatten & Wachstum“.",
      faq: [
        { q: "Ist die Knotenachse Schicksal?", a: "Nein. Astrakey liest sie als Einladung zur Entwicklung, nicht als Vorbestimmung." },
    ...
    en: {
      ...
      seoDescription: "What the lunar nodes are, how Astrakey calculates the nodal axis and what north and south node suggest about your direction of growth.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey calculates the mean nodal axis arithmetically from the ephemeris and assigns it to your signs/houses.",
      revealsTitle: REV_EN,
      reveals: "Your direction of growth (north node) and your comfort zone (south node). Feeds “Soul path” and “Shadow & growth”.",
      faq: [
        { q: "Are the nodes fate?", a: "No. Astrakey reads them as an invitation to develop, not as predestination." },
  ...
  },
  {
    ...
    de: {
      ...
      seoDescription: "Was das persönliche Jahr ist, wie Astrakey deinen numerologischen Jahreszyklus berechnet und wie er deine Tagesimpulse über die Zeit färbt.",
      ...
      howTitle: HOW_DE,
      how: "Astrakey berechnet dein persönliches Jahr deterministisch und verbindet es mit deinen übrigen Zyklen, um Timing-Impulse zu erden.",
      revealsTitle: REV_DE,
      ...
      faq: [
        ...
        { q: "Wann wechselt das persönliche Jahr?", a: "Je nach Methode zum Kalenderjahr oder rund um den Geburtstag – Astrakey weist die verwendete Methode aus." }
      ]
    },
    en: {
      name: "Personal year",
      ...
      seoDescription: "What the personal year is, how Astrakey calculates your numerological year cycle and how it colours your daily impulses over time.",
      ...
      howTitle: HOW_EN,
      how: "Astrakey calculates your personal year deterministically and connects it with your other cycles to ground timing impulses.",
      revealsTitle: REV_EN,
      ...
      faq: [
        ...
        { q: "When does the personal year change?", a: "Depending on the method, at the calendar year or around your birthday — Astrakey states the method used." }
      ]
    }
  },
  simpleSystem({
    ...
    computed: "Astrakey nutzt Big-Five-Werte nur, wenn sie durch einen Fragebogen oder durch ausdrueckliche Selbsteinschaetzung vorliegen. Die Auswertung bleibt beschreibend und wird nicht als klinische Diagnostik verwendet.",
    computedEn: "Astrakey only uses Big Five values when they come from a questionnaire or explicit self-assessment. The result remains descriptive and is not used as clinical diagnostics.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey leitet RIASEC nicht heimlich ab, sondern arbeitet mit expliziten Antworten zu Taetigkeiten, Umfeldern und bevorzugten Arbeitsweisen.",
    computedEn: "Astrakey does not infer RIASEC in the background. It works with explicit answers about activities, environments and preferred ways of working.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey kombiniert Selbstauskunft zu Schlaf, Energie, Fokusfenstern und Regeneration mit wiederkehrenden Tagesmustern. Es ersetzt keine Schlafdiagnostik.",
    computedEn: "Astrakey combines self-reported sleep, energy, focus windows and recovery with recurring daily patterns. It does not replace sleep diagnostics.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey erstellt aus dem Geburtsdatum ein Lo-Shu-Raster und betrachtet wiederkehrende oder fehlende Zahlen als symbolische Reflexionshinweise.",
    computedEn: "Astrakey creates a Lo Shu grid from the birth date and reads repeated or missing numbers as symbolic reflection cues.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey berechnet den Wochentag der Geburt und ordnet ihn einem einfachen Mahabote-Schema zu. Die Deutung bleibt als kulturell inspiriertes Symbolmodell gekennzeichnet.",
    computedEn: "Astrakey calculates the weekday of birth and maps it to a simple Mahabote pattern. The interpretation is marked as a culturally inspired symbolic model.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey verschiebt die Radix-Positionen rechnerisch auf den Nordknoten-Nullpunkt und vergleicht das Ergebnis mit dem normalen Geburtshoroskop.",
    computedEn: "Astrakey mathematically shifts natal positions to the north-node zero point and compares the result with the standard birth chart.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey ordnet Geburtsdatum und Kalenderlogik einer Kartenposition zu und nutzt ausschliesslich eigene, nicht kopierte Deutungstexte.",
    computedEn: "Astrakey maps birth date and calendar logic to a card position and uses only original, non-copied interpretation texts.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey berechnet Geburtskarten aus Quersummen des Geburtsdatums und verwendet eigene Archetypenbeschreibungen statt deck-spezifischer geschuetzter Texte.",
    computedEn: "Astrakey calculates birth cards from digit sums of the birth date and uses original archetype descriptions instead of deck-specific protected texts.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey ordnet Planetenpositionen ihren Tierkreisgraden zu und nutzt selbst formulierte, kurze Motivtexte statt geschuetzter Originalformulierungen.",
    computedEn: "Astrakey maps planetary positions to their zodiac degrees and uses original short motive texts instead of protected source wording.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey berechnet aus Geburtsdaten planetare Linien und Standortbezug. Ortsdeutungen werden vorsichtig als Resonanzhinweis formuliert.",
    computedEn: "Astrakey calculates planetary lines and location references from birth data. Place interpretations are phrased carefully as resonance cues.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey berechnet relevante Zusatzpunkte und wertet nur enge, transparent definierte Orben. Die Texte sind eigene Reflexionsdeutungen.",
    computedEn: "Astrakey calculates relevant additional points and evaluates only tight, transparently defined orbs. The texts are original reflection interpretations.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey nutzt TCM-inspirierte Fragen zu Energie, Temperatur, Rhythmus und Belastung. Das Ergebnis ist keine medizinische Diagnose.",
    computedEn: "Astrakey uses TCM-inspired questions about energy, temperature, rhythm and strain. The result is not a medical diagnosis.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey verarbeitet Staerken nur aus Selbstauskunft oder importierten Ergebnissen, wenn der Nutzer sie aktiv bereitstellt.",
    computedEn: "Astrakey only processes strengths from self-report or imported results when the user actively provides them.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey nutzt Spiral-Dynamics-inspirierte Fragen zu Werten, Konfliktlogik und Entscheidungsrahmen. Es bleibt ein Orientierungsmodell, keine Einstufung des Menschen.",
    computedEn: "Astrakey uses Spiral-Dynamics-inspired questions about values, conflict logic and decision frames. It remains an orientation model, not a ranking of people.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey nutzt 16-Type-Signale nur ueber Selbstauskunft und behandelt sie als Sprache fuer Praeferenzen, nicht als starre Identitaet.",
    computedEn: "Astrakey uses 16 Types signals only through self-report and treats them as language for preferences, not as rigid identity.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey nutzt eine eigene, allgemein gehaltene Lebensbaum-Zuordnung und vermeidet es, geschuetzte oder traditionsgebundene Spezialtexte zu uebernehmen.",
    computedEn: "Astrakey uses its own general Tree of Life mapping and avoids adopting protected or tradition-bound specialist texts.",
  ...
  simpleSystem({
    ...
    computed: "Astrakey nutzt Oracle-Cards nicht als Fremddeck, sondern als eigenes Motivsystem mit eigenen Begriffen, Bildern und Texten.",
    computedEn: "Astrakey does not use Oracle Cards as a third-party deck, but as its own motive system with original terms, images and texts.",
