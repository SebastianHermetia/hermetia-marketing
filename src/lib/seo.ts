...
const localizedSeoFallbacks: Partial<Record<Locale, LocalSeoCopy>> = {
  fr: {
    ...
    pages: {
      ...
      "/journaling": "Journal",
      "/vollprofil-buch": "Livre de profil complet",
      "/companion": "Companion",
      "/profil-verfeinern": "Affiner le profil",
  ...
  es: {
    ...
    pages: {
      ...
      "/journaling": "Diario",
      "/vollprofil-buch": "Libro de perfil completo",
      "/companion": "Companion",
      "/profil-verfeinern": "Refinar perfil",
  ...
  it: {
    ...
    pages: {
      ...
      "/journaling": "Diario",
      "/vollprofil-buch": "Libro del profilo completo",
      "/companion": "Companion",
      "/profil-verfeinern": "Affinare il profilo",
  ...
  nl: {
    ...
    pages: {
      ...
      "/journaling": "Journal",
      "/vollprofil-buch": "Volledig profielboek",
      "/companion": "Companion",
      "/profil-verfeinern": "Profiel verfijnen",
  ...
  pl: {
    ...
    pages: {
      ...
      "/journaling": "Dziennik",
      "/vollprofil-buch": "Pelna ksiega profilu",
      "/companion": "Companion",
      "/profil-verfeinern": "Doprecyzuj profil",
      "/beziehungen": "Relacje",
    },
  },
  pt: {
    ...
    pages: {
      ...
      "/journaling": "Diario",
      "/vollprofil-buch": "Livro de perfil completo",
      "/companion": "Companion",
      "/profil-verfeinern": "Refinar perfil",
  ...
  sv: {
    ...
    pages: {
      ...
      "/journaling": "Journal",
      "/vollprofil-buch": "Fullständig profilbok",
      "/companion": "Companion",
      "/profil-verfeinern": "Förfina profil",
