...
export const localizedPacks: Record<Exclude<Locale, "de" | "en">, LocalePack> = {
  ...
  pl: {
    ...
    lead: "Ta strona wyjaśnia Astrakey w lokalnym języku redakcyjnym, z jasną metodą, widocznymi granicami i bezpłatnym startem profilu.",
    ...
    question: "Co oznacza ten temat w Astrakey?",
    ...
    glossaryIntro: "Ten termin pomaga zrozumieć metodę, dane i język Astrakey.",
...
function fallbackPack(locale: string, soulMap: string, convergence: string, startFree: string): LocalePack {
  const profiles: Record<string, Partial<LocalePack>> = {
    hr: { learnMore: "Saznajte više", readMore: "Pročitajte više", faq: "Česta pitanja", overview: "Pregled", method: "Metoda", limits: "Granice", privacy: "Podaci i sigurnost", premium: "Premium dubina", daily: "Dnevni impuls", relationship: "Odnos", book: "Knjiga profila", title: "Astrakey povezuje sustave, podatke i osobnu refleksiju", lead: "Ova stranica donosi lokalnu uredničku verziju s jasnom metodom i vidljivim granicama.", body: "Astrakey pretvara izračunate signale i dobrovoljne odgovore u miran prostor za samorefleksiju.", question: "Što ova tema znači u Astrakey?", answer: "Pomaže razumjeti profil, podatke, konvergenciju i odgovorne granice prije plaćene dubine.", section: "Urednička orijentacija", safeNote: "Inspiracija za samorefleksiju, bez dijagnoze, terapije ili sigurnog predviđanja." },
    cs: { learnMore: "Zjistit více", readMore: "Číst dál", faq: "Časté otázky", overview: "Přehled", method: "Metoda", limits: "Hranice", privacy: "Data a bezpečnost", premium: "Prémiová hloubka", daily: "Denní impulz", relationship: "Vztah", book: "Kniha profilu", title: "Astrakey propojuje systémy, data a osobní reflexi", lead: "Tato stránka nabízí místní redakční verzi s jasnou metodou a viditelnými hranicemi.", body: "Astrakey převádí vypočtené signály a dobrovolné odpovědi do klidné sebereflexe.", question: "Co toto téma znamená v Astrakey?", answer: "Pomáhá pochopit profil, data, konvergenci a odpovědné hranice před placenou hloubkou.", section: "Redakční orientace", safeNote: "Inspirace k sebereflexi, bez diagnózy, terapie nebo jisté předpovědi." },
    ...
    hu: { learnMore: "Tudjon meg többet", readMore: "Olvasson tovább", faq: "Gyakori kérdések", overview: "Áttekintés", method: "Módszer", limits: "Határok", privacy: "Adatok és biztonság", premium: "Prémium mélység", daily: "Napi impulzus", relationship: "Kapcsolat", book: "Profilkönyv", title: "A Astrakey rendszereket, adatokat és személyes önreflexiót kapcsol össze", lead: "Ez az oldal helyi szerkesztett változatot ad világos módszerrel és látható határokkal.", body: "A Astrakey számított jeleket és önkéntes válaszokat alakít nyugodt önreflexióvá.", question: "Mit jelent ez a téma az Astrakey-ben?", answer: "Segít megérteni a profilt, az adatokat, a konvergenciát és a felelős határokat a fizetett mélység előtt.", section: "Szerkesztői tájékozódás", safeNote: "Inspiráció önreflexióhoz, diagnózis, terápia vagy biztos jóslat nélkül." },
    ...
    sk: { learnMore: "Zistiť viac", readMore: "Čítať ďalej", faq: "Časté otázky", overview: "Prehľad", method: "Metóda", limits: "Hranice", privacy: "Dáta a bezpečnosť", premium: "Prémiová hĺbka", daily: "Denný impulz", relationship: "Vzťah", book: "Kniha profilu", title: "Astrakey prepája systémy, dáta a osobnú reflexiu", lead: "Táto stránka prináša lokálnu redakčnú verziu s jasnou metódou a viditeľnými hranicami.", body: "Astrakey premieňa vypočítané signály a dobrovoľné odpovede na pokojnú sebareflexiu.", question: "Čo táto téma znamená v Astrakey?", answer: "Pomáha pochopiť profil, dáta, konvergenciu a zodpovedné hranice pred platenou hĺbkou.", section: "Redakčná orientácia", safeNote: "Inšpirácia na sebareflexiu, bez diagnózy, terapie alebo istej predpovede." },
    sl: { learnMore: "Izvedite več", readMore: "Preberite naprej", faq: "Pogosta vprašanja", overview: "Pregled", method: "Metoda", limits: "Meje", privacy: "Podatki in varnost", premium: "Premium globina", daily: "Dnevni impulz", relationship: "Odnos", book: "Knjiga profila", title: "Astrakey povezuje sisteme, podatke in osebno refleksijo", lead: "Ta stran prinaša lokalno uredniško različico z jasno metodo in vidnimi mejami.", body: "Astrakey pretvori izračunane signale in prostovoljne odgovore v mirno samorefleksijo.", question: "Kaj ta tema pomeni v Astrakey?", answer: "Pomaga razumeti profil, podatke, konvergenco in odgovorne meje pred plačano globino.", section: "Uredniška orientacija", safeNote: "Navdih za samorefleksijo, brez diagnoze, terapije ali zanesljive napovedi." },
