...
const checks = [
  ...
  ["System detail has literature recommendations", systemDetail.includes("Bücher zu Human Design") && systemDetail.includes("Understanding Human Design") && systemDetail.includes("neutrale Buchsuchen")],
  ["System detail book links are nofollow", systemDetail.includes("rel=\"nofollow noopener noreferrer\"") && systemDetail.includes("Hermetia zeigt hier keine Preise oder Verfügbarkeit")],
  ["System detail has book structured data", systemDetail.includes("\"@type\":\"Book\"") && systemDetail.includes("Bücher zu Human Design")],
  ...
  ["Systems hub has literature recommendations", systemsHub.includes("Bücher, die die Systeme verständlicher machen") && systemsHub.includes("The Inner Sky") && systemsHub.includes("The Gene Keys")],
  ["Systems hub literature has compliance note", systemsHub.includes("Die Links öffnen eine neutrale Buchsuche") && systemsHub.includes("Preise und Verfügbarkeit werden hier nicht angezeigt")],
  ["Systems hub has book structured data", systemsHub.includes("\"@type\":\"Book\"") && systemsHub.includes("Bücher zu den Hermetia-Systemen")],
  ...
  ["Use cases page has conversion principles", useCases.includes("Conversion-Prinzip") && useCases.includes("Neugier führt zur Anmeldung")],
  ...
  ["EN use cases page has localized conversion longform", enUseCases.includes("Where Hermetia is especially useful") && enUseCases.includes("From first interest to paid depth") && enUseCases.includes("Curiosity leads to signup")],
  ...
  ["Profile book page has expanded FAQ and tracked CTAs", profileBook.includes("Welche Kapitel enthält ein Vollprofil") && profileBook.includes("Warum ist das Vollprofil Premium") && profileBook.includes("utm_content=vollprofil-buch-inline-1") && profileBook.includes("utm_content=vollprofil-buch-final")],
